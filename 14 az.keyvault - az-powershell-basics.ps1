...
$secret = Set-AzKeyVaultSecret -VaultName $myVaultName -Name 'AdminPassword' -SecretValue $secretValue

# If we need to get the secret value text
(Get-AzKeyVaultSecret -vaultName $myVaultName -name "AdminPassword").SecretValueText